    ...
    return (
        <Box sx={{
            ...
            <Grid container alignItems='center' justifyContent='start'>
                ...
                <Grid item>
                    <StatCard title='Fees Generated' value={formatAmount(props.arbitrable.ethFees, props.chainId, true, true)} subtitle={ethInfo ? (ethInfo.current_price * Number(new DecimalBigNumber(BigNumber.from(props.arbitrable.ethFees), 18))).toLocaleString(undefined, dollarFormat) + ' at current price' : <Skeleton />} image={ETHER} />
                </Grid>
